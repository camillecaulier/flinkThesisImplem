...
public class MaxAggregateAware implements CompleteOperator<EventBasic> {
    ...
    int parallelism;
    int choices;
    public MaxAggregateAware(String csvFilePath, StreamExecutionEnvironment env , int splitParallelism , int choices) {
    ...
    public DataStream<EventBasic> execute(){
        ...
        DataStream<EventBasic> operatorBasicStream = mainStream
                .partitionCustom(new keygrouping.cam_n(choices ,parallelism), value->value.key )
