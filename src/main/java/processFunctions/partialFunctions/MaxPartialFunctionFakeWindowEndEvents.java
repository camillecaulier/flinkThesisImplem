...
public class MaxPartialFunctionFakeWindowEndEvents extends ProcessFunction<EventBasic, EventBasic> {
    ...
    public MaxPartialFunctionFakeWindowEndEvents(long windowTime) {
