...
public class MeanPartialFunctionFakeWindowEndEventsMultiSource extends ProcessFunction<EventBasic, EventBasic> {
    ...
    public MeanPartialFunctionFakeWindowEndEventsMultiSource(long windowTime, int outOfOrderness, int numberOfWindows) {
